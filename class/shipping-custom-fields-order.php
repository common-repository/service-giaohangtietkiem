                ...
                ?>
                            <?php add_thickbox(); ?>
                                    <div class="svw-create-order">
                                        <a
                                                href="#TB_inline?width=600&height=425&inlineId=svw-modal-create-order-shipping-ghtk"
                                                style="width: 100%"
                                                title="TẠO MÃ VẬN ĐƠN GHTK"
                                                class="thickbox button turquoise active">
                                            <?php esc_html_e('TẠO MÃ VẬN ĐƠN GHTK', 'svw' ); ?>
                                        </a>
                                    </div>
                                    <div id="svw-modal-create-order-shipping-ghtk" style="display:none;">
                                        <div id="create_order">
                                            <div class="svw-row" style="border-bottom: 1px solid #ccc;">
                                                <div class="svw-col-6 sender">
                                                    <div class="svw-col-12">
                                                        <div class="title"><?php esc_html_e( 'Thông tin lấy hàng', 'svw' ); ?></div>
                                                    </div>
                                                ...
                                                <div class="svw-col-6 recipient">
                                                    <div class="svw-col-12">
                                                        <div class="title"><?php esc_html_e( 'Thông tin người nhận hàng', 'svw' ); ?></div>
                                            ...
                                            <div class="svw-row">
                                                <div class="svw-col-6 parcel">
                                                    <div class="sub-content">
                                                        <div class="svw-col-12">
                                                            <div class="title"><?php esc_html_e( 'Thông tin hàng hóa', 'svw' ); ?></div>
                                                        </div>
                                                        <div class="svw-row item">
                                                            <div class="svw-col-5">
                                                        ...
                                                        <div class="svw-row item">
                                                            <div class="svw-col-5">
                                                                <label for="#expenses"><?php esc_html_e( 'Tiền Thu Hộ:', 'svw' ); ?></label>
                                                            </div>
                                                            <div class="svw-col-7">
                                                        ...
                                                        <div class="svw-row item">
                                                            <div class="svw-col-5">
                                                                <label><?php esc_html_e( 'Tổng tiền thu:', 'svw' ); ?></label>
                                                            </div>
                                                            <div class="svw-col-7">
                                                ...
                                                <div class="svw-col-6 package">
                                                    <div class="sub-content">
                                                        <div class="svw-col-12">
                                                            <div class="title"><?php esc_html_e( 'Ghi Chú:', 'svw' ); ?></div>
                                                        </div>
                                                        <div class="svw-col-12">
                            ...
                            <?php else : ?>
                                <div class="svw-exits">
                                    <div style="width: 100%;" class="button purple active"><?php echo esc_html__( 'GHTK: ', 'svw' ).$ghtk_code; ?></div>
                                </div>
                                <div class="svw-exits">
                                    <div
                                            class="svw-ghtk-status button orange active"
                                            style="width: 100%;"
                                            data-ghtk_code=<?php echo esc_attr( $ghtk_code ); ?>
                                            data-token="<?php echo esc_attr( $sender_token ); ?>"><?php esc_html_e( 'Trạng Thái:', 'svw' ); ?> <span></span>
                                    </div>
                                </div>
                                <div class="svw-exits">
                                    <a id="svw_cancel_package_ghtk"
                                       class="button button-primary"
                                       name="save"
                                       value="Hủy đơn"
                                       style="width: 100%;"
                                       data-ghtk_code=<?php echo esc_attr( $ghtk_code ); ?>
                                       data-token="<?php echo esc_attr( $sender_token ); ?>"
                                    >
                                        <?php esc_html_e('HỦY ĐƠN HÀNG', 'svw' ); ?>
                                    </a>
                                </div>
                                <div class="svw-exits">
                                    <a
                                            href="admin-ajax.php?action=print_package_ghtk&ghtk_code=<?= esc_attr( $ghtk_code ); ?>&token=<?= esc_attr( $sender_token ); ?>"
                                            style="width: 100%"
                                            target="_blank"
                                            class="svw-ghtk-print button orange active">
                                        In đơn hàng
                                    </a>
                                </div>
                            <?php endif; ?>
